...
class SearchIndex {
    ...
    addSource(content, link = "") {
        ...
        for (let i = 0; i < lineArray.length; i++) {
            ...
            if (!langStopWords) {
                throw new Error("Could not find language in list of stop words.");
            }
...
function unpair(z) {
    var sqrtz = Math.floor(Math.sqrt(z)), sqz = sqrtz * sqrtz;
